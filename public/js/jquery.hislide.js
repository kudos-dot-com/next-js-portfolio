...
// import slide from '../public/js/jquery.hislide'

// const Slider = () => {
//     useEffect(() => {
//         window.jQuery = require('../public/js/jquery.min');
//         window.Diamonds = require('../public/js/jquery.hislide');
...
//             </Head>
//         <div ref={slide} className={`${style.slide} ${style.hislide}`}>
//             <div className={style.hiprev}></div>
//             <div className={style.hinext}></div>
//             <ul>
//                 {
